...
test('Check home page its contains header', async () => {
  ...
  expect(paragraph).toEqual('Lead tech-co in Fastion Industery');
});
...
test('Check WebApp its contains header/nav', async () => {
  ...
  const navComponent =
    ...
    '<a class="nav-link" href="http://www.intelistyle.com/" target="_blank" rel="noreferrer">InteliStyle Official</a></li></ul>' +
